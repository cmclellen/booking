...
# az deployment group create --name $DEPLOYMENT_NAME --resource-group $RESOURCE_GROUP_NAME --template-file $TEMPLATE_FILE --parameters $PARAM_FILE
...
# az ad sp create-for-rbac --name GHReservation --role contributor --scope /subscriptions/761399c5-3790-4380-b6a8-a11554fafa7a/resourceGroups/Reservation